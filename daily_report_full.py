...
import openpyxl
import numpy as np
from str_pptx import keys_table_sum_full_FULL, keys_main_full
...
def make_daily_full_presentation(ais_file, previous_period, date):
    dist_path = ""
    date_text = f"{date}"
    ...
    presentation_maket = "makets/presentation/daily-full-presentation.pptx"
    ...
    keys_short_table = keys_table_sum_full_FULL.copy()
